...
AND c.c_balance > (SELECT VALUE AVG(c1.c_balance) FROM customer c1 WHERE c1.c_balance > 0.00
AND SUBSTR1(c1.c_phone,1,1) IN ['1','2','3','4','5','6','7'])[0]
AND NOT EXISTS (SELECT VALUE 1 FROM orders o WHERE o.o_c_id = c.c_id AND o.o_w_id = c.c_w_id AND o.o_d_id = c.c_d_id
