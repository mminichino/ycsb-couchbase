 ...
 */
public class SQLStatusThread extends Thread {
  ...
  private final List<SQLClientThread> clients;
   ...
   */
  public SQLStatusThread(CountDownLatch completeLatch, List<SQLClientThread> clients,
