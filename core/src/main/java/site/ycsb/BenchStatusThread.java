 ...
 */
public class BenchStatusThread extends Thread {
  ...
  private final List<BenchClientThread> clients;
   ...
   */
  public BenchStatusThread(CountDownLatch completeLatch, List<BenchClientThread> clients,
  ...
  private long computeStats(final long startTimeMs, long startIntervalMs, long endIntervalMs,
    ...
    for (BenchClientThread t : clients) {
