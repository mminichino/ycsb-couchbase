...
public class CouchbaseClientBinding extends DB {
  ...
  public void init() throws DBException {
    ...
    String hostname = properties.getProperty(COUCHBASE_HOST, "127.0.0.1");
    String username = properties.getProperty(COUCHBASE_USER, "Administrator");
    String password = properties.getProperty(COUCHBASE_PASSWORD, "password");
